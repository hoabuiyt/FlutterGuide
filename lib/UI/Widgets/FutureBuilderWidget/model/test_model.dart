...
TestFutureBuilderWidget responseFromJson(String jsonString) {
  final jsonData = json.decode(jsonString);
  return TestFutureBuilderWidget.fromJson(jsonData);
}
...
///the response
class TestFutureBuilderWidget {
  int userId;
  int id;
  String title;
  String body;

  TestFutureBuilderWidget({
    this.userId,
    this.id,
    this.title,
    this.body,
  ...
  factory TestFutureBuilderWidget.fromJson(Map<String, dynamic> json) => new TestFutureBuilderWidget(
    userId: json["userId"],
    id: json["id"],
    title: json["title"],
    body: json["body"],
